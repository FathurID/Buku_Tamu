		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				...
				<header class="sp-header">
					<div class="logo-wrap">
						<a href="<?php base_url(); ?>">
							<img class="brand-img" src="./assets/dist/img/logo.png" alt="brand" width="50"/>
						</a>
					</div>
				</div>
				...
				<div class="modal-body">
					...
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" name="input_nama" id="nama" placeholder="Masukkan Nama" autocomplete="off">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="input_alamat" id="alamat" placeholder="Masukkan Alamat" autocomplete="off">
						</div>
						<div class="form-group">
							<label class="control-label mb-10" for="nomoe">No. Telp</label>
							<input type="text" class="form-control" name="input_nomor" id="nomor" placeholder="Masukkan No. Telp" autocomplete="off">
						</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							<label class="control-label mb-10" for="edit_nomor">No. Telp</label>
							<input type="text" class="form-control" name="edit_nomor" id="edit_nomor" placeholder="Masukkan No. Telp">
						</div>
	...
	<script>
		...
		$(document).ready(function () {
					...
					success: function (data) {
						...
						for (i = 0; i < data.length; i++) {
							html += '<tr id="' + data[i].id_tamu + '">' +
								...
								'<td>' + data[i].waktu + '</td>' +
								'<td>' +
								'<button class="btn btn-xs btn-primary" style="padding-left: 10px;padding-right: 10px;" data-toggle="modal" data-target="#form-edit" id="btn-edit" data-id="' + data[i].id_tamu + '" data-nama="' + data[i].nama + '" data-jk="' + data[i].jenis_kelamin + '" data-jk="' + data[i].jenis_kelamin + '" data-alamat="' + data[i].alamat + '" data-nomor="' + data[i].nomor + '"> <i class="fa fa-pencil"></i></button> ' +
			...
			$('#btn-tambah').click(function () {
				var arg = {
					resultFunction: function (result) {
						...
						// document.getElementById("input_nomor").innerHTML = array_tamu[3];
			...
			$('#form-tambah').on('hidden.bs.modal', function (e) { // Ketika Modal Dialog di Close / tertutup
				$('#form-tambah #nama, #form-tambah #alamat, #form-tambah #nomor').val('') // Clear inputan menjadi kosong
			})
		})
