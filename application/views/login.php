...
<html lang="en">
	<head>
		...
		<title>Aplikasi Kelompok Tamu</title>
		...
		<div class="wrapper pa-0">
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="<?php base_url(); ?>">
						<img class="brand-img mr-10" src="./assets/dist/img/logo.png" alt="brand" width="50"/>
						<span class="brand-text">Ciputat</span>
					</a>
				</div>
								...
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											...
											<img src="./assets/dist/img/bsi.png" class="rounded" alt="bsi" style="width:200px;height:200px;">
											</div>
											<h3 class="text-center txt-dark mb-10">Masuk Ke Aplikasi Tamu</h3>
										...
										<div class="form-wrap">
											<form action="login/aksi_login" method="post">
												<div class="form-group">
													...
													<input type="text" class="form-control" required="" id="username" name="username" placeholder="Masukkan Nama Pengguna" autocomplete="off">
												</div>
												<div class="form-group">
													<label class="pull-left control-label mb-10" for="password">Kata Sandi</label>
													<div class="clearfix"></div>
													<input type="password" class="form-control" required="" id="password" name="password" placeholder="Masukkan Kata Sandi" autocomplete="off">
												</div>
