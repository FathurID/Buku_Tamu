...
class Mtamu extends CI_Model {
  ...
  public function validation($mode){
    ...
    if($mode == "save"){
      ...
      $this->form_validation->set_rules('input_nomor', 'Nomor', 'required|numeric|max_length[15]');
    }else if($mode == "update"){
      ...
      $this->form_validation->set_rules('edit_nomor', 'Nomor', 'required|numeric|max_length[15]');
    }
  ...
  public function save(){
    $data = array(
      ...
      "nomor" => $this->input->post('input_nomor'),
